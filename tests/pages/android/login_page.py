"""
Login Page Object — Android Native (Appium + UIAutomator2).
...
_LOC = load_locators("android")["login"]
_DASH = load_locators("android")["dashboard"]


class AndroidLoginPage(BaseNativePage):
    """Page object for the Android native login screen (SCRUM-2)."""
    ...
    def get_password_field_class(self) -> str:
        """Return the class of the password field — EditText vs SecureEditText."""
